...
I use double linked list to keep the frequency of each key. In each double linked list node, 
...
If the following node exist and the frequency is larger by one, 
add key to the keys of the following node, else create a new node and add it following the current node.
